...
describe("When I download the attached file in the wrong format", () => {  //je telecharge le fichier dans un mauvais format
  test ("It should display alert message", () => {//Alors je reste sur la newbill et un message apparait
    ...
    const testFormat = new File(["c'est un test"],"document.txt", { // création du fichier
    type: "document/txt"
    })
